...
void ADontLetMeGoCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void ADontLetMeGoCharacter::SetHasRifle(bool bNewHasRifle)
{
	bHasRifle = bNewHasRifle;
}

bool ADontLetMeGoCharacter::GetHasRifle()
{
	return bHasRifle;
}